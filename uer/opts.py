...
def optimization_opts(parser):
    ...
    parser.add_argument("--optimizer", choices=["adamw", "adafactor","sgd"],
                        default="adamw",
                        help="Optimizer type.")
    parser.add_argument("--scheduler", choices=["linear", "cosine", "cosine_with_restarts", "polynomial",
                                                "constant", "constant_with_warmup","steplr"],
...
def tokenizer_opts(parser):
    parser.add_argument("--tokenizer", choices=["bert", "bpe", "char", "space", "xlmroberta","nereng"], default="bert",
