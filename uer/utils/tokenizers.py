...
class NerengTokenizer(Tokenizer):
    """Runs end-to-end tokenziation."""
    ...
    def tokenize(self, text):
        if self.sp_model:
            ...
            split_tokens = []
            # t1 = text.split(" ")
            # t2 = self.basic_tokenizer.tokenize(text)
            # if len(t1) != len(t2):
            #     print("!!!!!!!!!!!!!!!",len(t1),len(t2)) 
            #     return True 
            for token in self.basic_tokenizer.tokenize(text):
        ...
        return split_tokens
class BasicNERTokenizer(object):
    ...
    def tokenize(self, text):
        ...
        for token in orig_tokens:
            ...
            split_tokens.extend(self._run_first_on_punc(token))
    ...
    def _run_first_on_punc(self, text):
